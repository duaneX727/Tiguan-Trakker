...
def run_analytics():
    ...
    for row in rows:
        ...
        # Guard EVERY value to guarantee it is a string before alignment happens
        date_val = str(date_str) if date_str is not None else "N/A"
        ...
        print(f"{date_val:<12} | {odo_val:<10} | {trip_val:<9} | {gal_val:<8} | {cost_val:<7} | {mpg_val:<5}")
